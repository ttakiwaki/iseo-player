...
import Toggle from "./SettingsComponents/Toggle/Toggle";
import Input from "./SettingsComponents/Input/Input";
    ...
    <div className="settings-body">
      <SettingsSection header="Appearance">
        <SettingsRow
          ...
          description="Switches theme to dark mode. When Vibrant Themes are enabled, the dark color palette adapts to suit the selected mode."
          control={
            <Toggle
              value={isDark}
              onChange={setDark}
        ...
        <SettingsRow
          ...
          description="Dynamically tints the library, player, and accent colors based on the currently playing album's artwork. Output theme is determined based on the original light / dark theme that is set. Requires embedded cover art or a folder image to take effect."
          control={
            <Toggle
      ...
      <SettingsSection header="Personalize">
        <SettingsRow
          icon={
            <svg
              role="img"
          ...
          description={
            <p>
              Show what you're listening to on your Discord profile. Requires
              the ISEO Discord RPC app to be running on your computer.{" "}
              <strong>
              ...
              Visit the{" "}
              <a
                href="https://github.com/ttakiwaki/iseo-rpc"
                target="_blank"
                className="selected"
              >
                iseo-rpc
        ...
        ></SettingsRow>
        <SettingsRow
          icon={<UserRound></UserRound>}
          title="Username"
          description={
            <p>
              Set your name to personalize your ISEO experience. Shown on the
              welcome screen upon loading the page.
            </p>
          }
          control={
            <Input
