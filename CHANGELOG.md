...
## [v4.2.12] — ISEO UI Overhaul

### Fixed

- apple-touch-icon not working as intended
...
## [v4.2.11] — ISEO UI Overhaul

### Added

- ".opus" audio file extension support
- apple-touch-icon to index.html

### Fixed

- Finally fixed! - Songs not moving to the next/previous track while using phone simultaneously. (Mobile)
...
## [v4.2.10] — ISEO UI Overhaul

### Fixed

- Songs not moving to the next/previous track while using phone simultaneously. (Mobile) im trying my best...
...
## [v4.2.9] — ISEO UI Overhaul

### Fixed

- Songs not moving to the next/previous track while using phone simultaneously. (Mobile)
...
## [v4.2.8] — ISEO UI Overhaul

### Fixed

- Songs not starting unless you're in the Playing tab. (Desktop)
